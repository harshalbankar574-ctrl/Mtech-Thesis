...
% Parameters
Monte_carlo = 100; %10;  % Change it to 1000 itereation for verification
max_iter = 30;         % Maximum number of SCA iterations (Change to 10000 this for monte carlo)
...
Avg_sumrate = mean(sumrate_All, 1);
sr = smooth(Avg_sumrate);
srr = smooth(sr);
